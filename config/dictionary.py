...
texts = {
    ...
    FR: {
        ...
        33: "montre 7",
        34: "arc en ciel 2",
        35: "Mise à jour, le bot est redémarré.",
        36: "Etre prêt"
...
def __assign_texts(lng_key: str):
    ...
    # Message 'Update'
    text_assignments[texts[MSG].get(11)] = texts[lng_key].get(35)
    # Command 'Standby'
    text_assignments[texts[CMD].get(24)] = texts[lng_key].get(36)
